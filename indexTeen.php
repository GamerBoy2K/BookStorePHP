...
<div class="mainPage" style="padding-top: 80px;">
    ...
    <div class="newBooks">
        ...
        <div class="bookItems">
            ...
            $all_books_sql="select * from product where category=2 ORDER BY date_time DESC LIMIT 6";
    ...
    <div class="newBooks">
        ...
        <?php 
            $all_books_sql="select * from product where category=2 ORDER BY total_sold DESC LIMIT 6";
            $result=mysqli_query($conn,$all_books_sql);
    ...
    <div class="newBooks">
        ...
        <?php 
            $all_books_sql="select * from product where category=2";
            $result=mysqli_query($conn,$all_books_sql);
